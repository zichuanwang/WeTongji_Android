...
public class InformationsFragment extends WTBaseFragment implements
	...
	/*
	 * public void loadMoreData(int page){ mAdapter.setLoadingData(true);
	 * mAdapter.notifyMayHaveMorePages();
	 * 
	 * ApiHelper apiHelper = ApiHelper.getInstance(mActivity); //By default we
	 * fetch all kind of informations from the server Bundle args =
	 * apiHelper.getInformations(page, mSelectType);
	 * getLoaderManager().restartLoader(WTApplication.NETWORK_LOADER_DEFAULT,
	 * args, this); }
	 */
