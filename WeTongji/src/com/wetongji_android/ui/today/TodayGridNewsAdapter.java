...
public class TodayGridNewsAdapter extends TodayGridBaseAdapter<Information> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(info!=null){
			...
			if(info.getImages()==null||info.getImages().isEmpty()||info.getImages().get(0).equals(WTApplication.MISSING_IMAGE_URL)){
				...
				aq.id(holder.ivGridImage).image(info.getImages().get(0), true, true, 300, 0, null, AQuery.FADE_IN_NETWORK, 1f);
