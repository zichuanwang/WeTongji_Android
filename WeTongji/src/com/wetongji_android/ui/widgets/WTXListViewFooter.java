...
public class WTXListViewFooter extends LinearLayout {
	...
	public WTXListViewFooter(Context context) {
		super(context);
		initView(context);
	}
	
	public WTXListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
