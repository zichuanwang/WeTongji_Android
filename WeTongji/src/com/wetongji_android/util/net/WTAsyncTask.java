 ...
 * Date: 12-9-1
 */
public abstract class WTAsyncTask<Params, Progress, Result> {
     ...
     */
    public final WTAsyncTask<Params, Progress, Result> execute(Params... params) {
	...
	public final WTAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
                                                                         Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        @SuppressWarnings("rawtypes")
		final WTAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(@SuppressWarnings("rawtypes") WTAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
